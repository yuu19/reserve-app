...
export const BookingNotificationEmail = ({
  ...
  return (
    <Html lang="ja">
      <Head />
      <Preview>{organizationName} の予約通知</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Heading as="h2" style={styles.heading}>
            {eventLabel}
          </Heading>
          <Text style={styles.text}>{organizationName} の予約について更新がありました。</Text>
          <Section style={styles.detailSection}>
            <Text style={styles.detailText}>
              <strong>参加者:</strong> {participantName}
            </Text>
            <Text style={styles.detailText}>
              <strong>サービス:</strong> {serviceName}
            </Text>
            <Text style={styles.detailText}>
              <strong>人数:</strong> {participantsCount}
            </Text>
            <Text style={styles.detailText}>
              <strong>開始:</strong> {slotStartLabel}
            </Text>
            <Text style={styles.detailText}>
              <strong>終了:</strong> {slotEndLabel}
            </Text>
            {reason ? (
              <Text style={styles.detailText}>

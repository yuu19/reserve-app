...
export const billingSubscriptionAddonItem = sqliteTable(
  'billing_subscription_addon_item',
  {
    ...
    pendingEffectiveAt: integer('pending_effective_at', { mode: 'timestamp_ms' }),
    pendingProviderScheduleId: text('pending_provider_schedule_id'),
    pendingRequestedAt: integer('pending_requested_at', { mode: 'timestamp_ms' }),
    createdAt: defaultTimestampMs(),
    updatedAt: defaultUpdatedTimestampMs(),
  },
  (table) => [
